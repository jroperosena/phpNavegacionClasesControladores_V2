...
<body class="estiloBody">
    ...
    <header class="estiloHeader">
        ...
        <nav class="estiloNav">
            <ul class="estiloUl">
                <li class="estiloLi"><a  class="estiloLink"  href="../controlador/rutaControlador.php?opc=0"> Home </a></li>
                <li class="estiloLi"><a  class="estiloLink"  href="../controlador/rutaControlador.php?opc=1"> Algoritmos </a></li>
